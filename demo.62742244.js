...
},{"object-assign":13,"fbjs/lib/invariant":12,"fbjs/lib/emptyObject":14,"fbjs/lib/emptyFunction":15}],20:[function(require,module,exports) {
/**
...
},{"./emptyFunction":15}],25:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":12,"fbjs/lib/warning":20,"./lib/ReactPropTypesSecret":25}],8:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"object-assign":13,"fbjs/lib/invariant":12,"fbjs/lib/emptyObject":14,"fbjs/lib/warning":20,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":21}],4:[function(require,module,exports) {
'use strict';
...
},{"./isNode":34}],19:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":29}],9:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"fbjs/lib/invariant":12,"react":4,"fbjs/lib/ExecutionEnvironment":16,"object-assign":13,"fbjs/lib/emptyFunction":15,"fbjs/lib/getActiveElement":17,"fbjs/lib/shallowEqual":18,"fbjs/lib/containsNode":19,"fbjs/lib/emptyObject":14}],30:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":12,"react":4,"fbjs/lib/warning":20,"fbjs/lib/ExecutionEnvironment":16,"object-assign":13,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":21,"fbjs/lib/getActiveElement":17,"fbjs/lib/shallowEqual":18,"fbjs/lib/containsNode":19,"fbjs/lib/emptyObject":14,"fbjs/lib/hyphenateStyleName":23,"fbjs/lib/camelizeStyleName":24}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":9,"./cjs/react-dom.development.js":10}],32:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":15,"fbjs/lib/invariant":12,"fbjs/lib/warning":20,"object-assign":13,"./lib/ReactPropTypesSecret":25,"./checkPropTypes":21}],33:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":15,"fbjs/lib/invariant":12,"./lib/ReactPropTypesSecret":25}],26:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":32,"./factoryWithThrowingShims":33}],27:[function(require,module,exports) {
'use strict';
...
var Portal = function Portal(_ref) {
  var children = _ref.children,
      query = _ref.query;
  return _reactDom2.default.createPortal(children, document.querySelector(query));
};
...
},{"react-dom":5,"prop-types":26}],28:[function(require,module,exports) {
'use strict';
...
var absolute = exports.absolute = function absolute(x) {
  return x < 0 ? -x : x;
};

var drawPath = exports.drawPath = function drawPath(svg, path, startX, startY, endX, endY) {
...
var connectElements = exports.connectElements = function connectElements(container, svg, path, startElem, endElem) {
  ...
  var svgTop = container.getBoundingClientRect().top;
  var svgLeft = container.getBoundingClientRect().left;
  ...
  var startX = startCoord.left + 0.5 * startCoord.width - svgLeft; // x = left offset + 0.5*width - svg's left offset
  var startY = startCoord.top + startCoord.height - svgTop; // y = top offset + height - svg's top offset

  // calculate path's end (x,y) coords
  var endX = endCoord.left + 0.5 * endCoord.width - svgLeft;
...
var ReactConnectElements = function (_PureComponent) {
  _inherits(ReactConnectElements, _PureComponent);

  function ReactConnectElements() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, ReactConnectElements);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactConnectElements.__proto__ || Object.getPrototypeOf(ReactConnectElements)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      querySelector: 'body'
    }, _this.checkSelector = function () {
      if (document.querySelector(_this.props.selector)) {
        _this.setState({ querySelector: _this.props.selector }, function () {
          return _this.connectAll();
        });
      }
    }, _this.connectAll = function () {
      var elements = _this.props.elements;


      elements.map(function (element, index) {
        var start = document.querySelector(element.from);
        var end = document.querySelector(element.to);
        var path = document.querySelector('#path' + (index + 1));

        return (0, _utils.connectElements)(_this.svgContainer, _this.svg, path, start, end);
      });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(ReactConnectElements, [{
    ...
    value: function render() {
      ...
      return this.state.querySelector && _react2.default.createElement(
        _portal2.default,
  ...
  return ReactConnectElements;
}(_react.PureComponent);

ReactConnectElements.propTypes = {
...
ReactConnectElements.defaultProps = {
  overlay: 0,
  strokeWidth: 5,
  color: '#666'
};
exports.default = ReactConnectElements;
},{"react":4,"prop-types":26,"./portal":27,"./utils":28}],11:[function(require,module,exports) {
var bundleURL = null;
...
var Demo = function Demo() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'a',
        { href: 'https://github.com/emersonlaurentino/react-connect-elements' },
        _react2.default.createElement(
          'h1',
          null,
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('div', { className: 'element element1' }),
        _react2.default.createElement('div', { className: 'element element2' }),
        _react2.default.createElement('div', { className: 'element element3' })
      ),
      _react2.default.createElement(
        'div',
        { className: 'elements-row' },
        _react2.default.createElement('div', { className: 'element element4' })
      ),
      _react2.default.createElement(
        'div',
        { className: 'elements-row' },
        _react2.default.createElement('div', { className: 'element element5' }),
        _react2.default.createElement('div', { className: 'element element6' }),
        _react2.default.createElement('div', { className: 'element element7' })
      )
    ),
    _react2.default.createElement(
      'footer',
    ...
    _react2.default.createElement(_src2.default, {
      selector: '.elements',
      overlay: 10,
      elements: [{ from: '.element1', to: '.element4' }, { from: '.element2', to: '.element4' }, { from: '.element3', to: '.element4' }, { from: '.element5', to: '.element4' }, { from: '.element6', to: '.element4' }, { from: '.element7', to: '.element4' }]
    })
  );
};

(0, _reactDom.render)(_react2.default.createElement(Demo, null), document.querySelector('#root'));
},{"react":4,"react-dom":5,"../src":22,"./styles.css":3}],35:[function(require,module,exports) {
...
//# sourceMappingURL=/demo.62742244.map